...
// Note: WebRTC types (RTCSessionDescriptionInit, RTCIceCandidateInit) are
// browser-native. On the server side these are treated as opaque JSON objects
// that are simply forwarded between peers.
